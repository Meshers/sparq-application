package com.sparq.application.userinterface.database;
...
public class ApplicationContentProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.sparq.application.userinterface.database.ApplicationContentProvider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)){
            case EVENT:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.event";
            case EVENT_ID:
                return "vnd.android.cursor.item/vnd.com.sparq.application.event.id";
            case USER:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.user";
            case USER_ID:
                return "vnd.android.cursor.item/vnd.com.sparq.application.user.id";
            case QUESTIONARE:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.questionare";
            case QUESTIONARE_ID:
                return "vnd.android.cursor.item/vnd.com.sparq.application.questionare.id";
            case EVENT_CREATOR_QUESTIONARE:
                return "vnd.android.cursor.item/vnd.com.sparq.application.event.id.creator.id";
            case QUESTION:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.question";
            case QUESTION_ID:
                return "vnd.android.cursor.item/vnd.com.sparq.application.question.id";
            case QUESTIONARE_QUESTION:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.question";
            case ANSWER:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.answer";
            case ANSWER_ID:
                return "vnd.android.cursor.item/vnd.com.sparq.application.answer.id";
            case QUESTION_ANSWER:
                return "vnd.android.cursor.dir/vnd.com.sparq.application.answer.question.id";
            default:
