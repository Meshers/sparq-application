...
public class Constants {
    ...
    public static final String UI_ENABLE_BROADCAST_INTENT = "com.sparq.quizpolls.application.UI_ENABLE_INTENT";
    public static final String UI_DISABLE_BROADCAST_INTENT = "com.sparq.quizpolls.application.UI_DISABLE_INTENT";
