...
import com.sparq.quizpolls.application.layer.almessage.AlPollAnswer;
import com.sparq.quizpolls.application.layer.almessage.AlPollQuestion;
...
import com.sparq.quizpolls.application.layer.pdu.PollPdu;
        ...
        try{
            switch(type){
                ...
                case QUIZ_ANSWER:
                    ...
                    // check if corresponding question exists
                    if(mSessionQuizzes.keySet().contains(quizId)){
                        retreivedQuestion = mSessionQuizzes.get(quizId);
