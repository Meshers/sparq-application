...
public class ThreadPdu extends ApplicationLayerPdu{
    ...
    private final static int PAYLOAD_QUESTION_MAX_BYTES = TOT_SIZE_BT - PDU_QUESTION_HEADER_BYTES;
    ...
    private final static int PAYLOAD_ANSWER_MAX_BYTES = TOT_SIZE_BT - PDU_ANSWER_HEADER_BYTES;

    private final static int PDU_QUESTION_VOTE_HEADER_BYTES = TYPE_BYTES + THREAD_CREATOR_ID_BYTES + THREAD_ID_BYTES;
    private final static int PAYLOAD_QUESTION_VOTE_MAX_BYTES = TOT_SIZE_BT - PDU_QUESTION_VOTE_HEADER_BYTES;
    ...
    private final static int PAYLOAD_ANSWER_VOTE_MAX_BYTES = TOT_SIZE_BT - PDU_ANSWER_VOTE_HEADER_BYTES;
